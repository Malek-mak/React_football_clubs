    ...
    const formik = useFormik({
        ...
        ,onSubmit: (values)=>{
            ...
            .then(()=>{
                setMessage(
                    <MyMessage
                        MyMessageText = {"Club created succufully!"}
                        bgcolor= {"green"}
                    />
                )
                setTimeout(()=> {
    ...
    return (
        <div>
            <Box className={"TopBar"} >
                <AddBoxIcon/>
                <Typography sx={{marginLeft:'10px', fontWeight:'bold'}}>Create a new club!</Typography>
            </Box>
            ...
            <Box className={'FormBox'}>
                ...
                <Box className={'FormArea'}>
                    ...
                    <Box sx={{'marginTop': '15px'}}>
                        <Button type="submit" variant="contained">Create Club</Button>
                    </Box>
